...
<body>
	<h1 class="jumbotron"
		style="text-align: center; background-color: #00A693; color: #fff">Employee</h1>
	<div class="container">
		<div class="add-section text-center">
			<a href="get_employee_form" style="color: #fff;"
				class="btn btn-primary"><span class="glyphicon glyphicon-user"></span>
				Create Employee</a> <a href="get_all_employee" style="color: #fff;"
				class="btn btn-primary">Display All Employee</a>
...
<a href="restore_employee.jsp" style="color: #fff;">restore Employee</a></button>-->
	...
	<div class="text-center">
		<a href="/" class="btn btn-success">Welcome Page</a>
	</div>
