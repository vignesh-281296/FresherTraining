         ...
         <div class="form-group">        
             <div class="row">
                 ...
                 <div class="col-sm-6" style="margin-top: 5px;">
                     <input type="text" name="project_name" class="form-control" required="This is mandatory"/>
     ...
     <li class="list-group-item" style="background-color: #fffff;">                  
         <div class="form-group">        
             <div class="row">
                 ...
                 <div class="col-sm-6" style="margin-top: 5px;">
                     <input type="text" name="project_manager_name" class="form-control" required="This is mandatory"/>
     ...
     <li class="list-group-item" style="background-color: #fffff;">                  
         <div class="form-group">        
             <div class="row">
                 ...
                 <div class="col-sm-6" style="margin-top: 5px;">
                     <input type="date" name="start_date" class="form-control" required="This is mandatory"/>
     ...
     <li class="list-group-item" style="background-color: #fffff;">                  
         <div class="form-group">        
             <div class="row">
                 ...
                 <div class="col-sm-6" style="margin-top: 5px;">
                     <input type="date" name="end_date" class="form-control" required="This is mandatory"/>
