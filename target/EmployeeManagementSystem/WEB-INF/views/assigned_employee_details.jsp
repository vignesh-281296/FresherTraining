...
<body>
	<h1 class="jumbotron"
		style="text-align: center; background-color: #00A693; color: #fff">Assigned
		project Details</h1>
	<div class="container-fluid">
		<a href="/employee" class="btn btn-success" style="color: #fff;"><span
			class="glyphicon glyphicon-home"> Home</span></a>
	</div>
	<c:choose>
		<c:when test="${!assignEmployeeDetails.isEmpty()}">
